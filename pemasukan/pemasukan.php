    ...
    <main class="relative z-10 max-w-6xl mx-auto px-6 py-10">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-slate-400 text-sm mt-1">Daftar seluruh riwayat pemasukan</p>
            </div>

            <button type="button" onclick="document.getElementById('modalTambah').showModal()" class="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-emerald-500 hover:bg-emerald-400 text-slate-900 font-semibold transition shadow-lg shadow-emerald-500/30 w-fit">
                        ...
                        ?>
                            ...
                            <dialog id="modalEdit<?= $row['id']; ?>" class="backdrop:bg-slate-900/70 backdrop:backdrop-blur-sm rounded-2xl p-0 m-auto bg-transparent">
                                <div class="w-[90vw] max-w-md bg-slate-900/95 border border-white/20 rounded-2xl shadow-2xl p-6 sm:p-7">
                                    ...
                                    <form method="POST" action="edit_pemasukan.php?id=<?= $row['id']; ?>" class="space-y-4">
